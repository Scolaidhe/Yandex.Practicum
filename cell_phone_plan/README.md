...
После проверки гипотез мы подтвердили:

1. Средняя выручка пользователей тарифов «Ультра» и «Смарт» имеет статистически значимое различие.
2. Средняя выручка пользователей из Москвы не имеет статистического различия с выручкой пользователей других регионов.
