...
|2              |[Исследование надежности заемщиков](debtors_reliability_research/)|Разбираемся, влияет ли семейное положение и количество детей клиента на факт погашения кредита в срок. Анализируем данные о клиентах банка и определяем долю кредитоспособных|`предобработка данных` `Python` `Pandas`|
...
|9              |[Принятие решений в бизнесе](AB_tests/)|Анализируем результаты A/B-тестирования в крупном интернет-магазине, приоритизируем гипотезы|`Python` `Pandas` `Matplotlib` `SciPy` `A/B-тестирование` `проверка статистических гипотез`|
...
|11             |[Исследование рынка общественного питания](moscow_places_research)|Исследование рынка на основе открытых данных о заведениях общественного питания Москвы|`Python` `Pandas` `Matplotlib` `Seaborn` `Plotly` `визуализация данных`|
|12             |[Дашборд для Яндекс.Дзена](https://public.tableau.com/app/profile/nikita.ivanov6869/viz/Dzen_Dashboard2/sheet4?publish=yes) и [Презентация](https://disk.yandex.ru/i/EQ66mg4m7-f6Lw)|Разрабатываем и презентуем дашборд для анализа пользовательского взаимодействия в сервисе Яндекс.Дзен (Tableau Public)|`Python` `PostgreSQL` `Tableau` `продуктовые метрики` `построение дашбордов`|
|13             |[Выпускной проект](graduation_project/). [Ecom — cегментация товарного ассортимента в интернет-магазине](https://github.com/Scolaidhe/Yandex.Practicum/blob/master/graduation_project/ecom_research.ipynb), [Презентация](https://github.com/Scolaidhe/Yandex.Practicum/blob/master/graduation_project/analysis_of_assortment.pdf) и [Дашборд](https://public.tableau.com/app/profile/nikita.ivanov6869/viz/Dashboard_ecom/Dashboard1); [А/B тестирование](https://github.com/Scolaidhe/Yandex.Practicum/blob/master/graduation_project/ab_final_research.ipynb), [SQL](https://github.com/Scolaidhe/Yandex.Practicum/blob/master/graduation_project/SQL_final_task.ipynb)|Анализируем и сегментируем товарный ассортимент (результат оформляем в виде Презентации), проверяем результаты А/B тестирования и подтверждаем гипотезы, разрабатываем дашборд в Tableau Public. изучаем мобильное приложение посредством SQL-запросов. |`SQL` `PostgreSQL` `Python` `Pandas` `Matplotlib` `Seaborn` `классификация`  `Tableau` `продуктовые метрики` `построение дашбордов` `A/B-тестирование` `проверка статистических гипотез`|
